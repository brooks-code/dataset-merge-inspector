...
- [Contributing to missingMap](#contributing-to-missingmap)
...
```bash
git clone https://github.com/brooks-code/dataset-merge-inspector.git
cd dataset-merge-inspector
```
